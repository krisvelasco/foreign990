...
#   of number of tax-exempt orgs (from the Urban Institute's Business Master Files)
...
acs_controls <- read_csv("/Users/srojascabal/Desktop/000_f990_data/acs_2008_2019.csv",
                           col_types = cols(
                             GEOID = col_character(),
                             NAME = col_character(),
                             year = col_character(),
...
bmf_controls <- read_csv("/Volumes/SRC_FILES/0000_F990 Project/000_f990_data/bmf_exempt_orgs_state_years.csv",
  col_types = cols(
    YEAR = col_character(),
    STATE = col_character(),
...
write_csv(
  state_controls_new,
  "/Users/srojascabal/Desktop/000_f990_data/state_controls_0726.csv"
)
