...
#       Part 0 of Form 990
# -------------------------
part0 <- read_csv("/Volumes/SRC_DATA/000_f990_data/part_0.csv")
# the top of 990 form.
...
#       Part 9 of Form 990
#--------------------------
part9 <- read_csv("/Volumes/SRC_DATA/000_f990_data/part_ix.csv")
...
#-------------------------- 
write_csv(rtrn09_anti, "Datasets/230309_form990_rtrn09_anti_dirty.csv")
#--------------------------